...
export interface QryCustomer extends QryAddress {
	id: string
	name: string
	contact: string
	phone: string
...
export class Employee extends Address {
	id?: number
	lastName?: string
	firstName?: string
	title?: string
...
export interface QryEmployee extends QryAddress {
	id: number
	lastName: string
	firstName: string
	title: string
...
export class Supplier extends Address {
	id?: number
	name?: string
	contact?: string
	phone?: string
...
export interface QrySupplier extends QryAddress {
	id: number
	name: string
	contact: string
	phone: string
...
export let Addresses: Queryable<QryAddress>
